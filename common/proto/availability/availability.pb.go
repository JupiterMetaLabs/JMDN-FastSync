...
func (x *AvailabilityResponse) GetBlockHeight() uint64 {
	if x != nil {
...
const file_availability_availability_proto_rawDesc = "" +
	...
	"\x05phase\x18\x05 \x01(\v2\f.phase.PhaseR\x05phase\x12!\n" +
	"\fblock_height\x18\x06 \x01(\x04R\vblockHeightBDZBgithub.com/JupiterMetaLabs/JMDN-FastSync/common/proto/availabilityb\x06proto3"
