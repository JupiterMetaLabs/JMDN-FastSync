...
type Account struct {
	...
	// Consensus Identity
	TxNonce     uint64 `protobuf:"varint,8,opt,name=tx_nonce,json=txNonce,proto3" json:"tx_nonce,omitempty"`
	TxCountSent uint64 `protobuf:"varint,9,opt,name=tx_count_sent,json=txCountSent,proto3" json:"tx_count_sent,omitempty"`
...
func (x *Account) GetTxNonce() uint64 {
	if x != nil {
		return x.TxNonce
	}
	return 0
...
func (x *Account) GetTxCountSent() uint64 {
	if x != nil {
		return x.TxCountSent
	}
	return 0
}
