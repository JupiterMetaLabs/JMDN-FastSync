...
type Header struct {
	...
	TxnsRoot      string                 `protobuf:"bytes,3,opt,name=txns_root,json=txnsRoot,proto3" json:"txns_root,omitempty"`
	...
	CoinbaseAddr  []byte                 `protobuf:"bytes,7,opt,name=coinbase_addr,json=coinbaseAddr,proto3" json:"coinbase_addr,omitempty"`
	ZkvmAddr      []byte                 `protobuf:"bytes,8,opt,name=zkvm_addr,json=zkvmAddr,proto3" json:"zkvm_addr,omitempty"`
...
func (x *Header) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *Header) GetTxnsRoot() string {
	if x != nil {
		return x.TxnsRoot
	}
	return ""
...
func (x *Header) GetCoinbaseAddr() []byte {
	if x != nil {
...
func (x *Header) GetZkvmAddr() []byte {
	if x != nil {
		return x.ZkvmAddr
	}
	return nil
...
func (x *Header) GetBlockHash() []byte {
	if x != nil {
		return x.BlockHash
	}
	return nil
...
type Transaction struct {
	...
	Value          []byte                 `protobuf:"bytes,4,opt,name=value,proto3" json:"value,omitempty"` // big.Int
	Type           uint32                 `protobuf:"varint,5,opt,name=type,proto3" json:"type,omitempty"`  // uint8
	Timestamp      uint64                 `protobuf:"varint,6,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	ChainId        []byte                 `protobuf:"bytes,7,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"` // big.Int
	Nonce          uint64                 `protobuf:"varint,8,opt,name=nonce,proto3" json:"nonce,omitempty"`
	GasLimit       uint64                 `protobuf:"varint,9,opt,name=gas_limit,json=gasLimit,proto3" json:"gas_limit,omitempty"`
	GasPrice       []byte                 `protobuf:"bytes,10,opt,name=gas_price,json=gasPrice,proto3" json:"gas_price,omitempty"`                     // big.Int
	MaxFee         []byte                 `protobuf:"bytes,11,opt,name=max_fee,json=maxFee,proto3" json:"max_fee,omitempty"`                           // big.Int
	MaxPriorityFee []byte                 `protobuf:"bytes,12,opt,name=max_priority_fee,json=maxPriorityFee,proto3" json:"max_priority_fee,omitempty"` // big.Int
	...
	V              []byte                 `protobuf:"bytes,15,opt,name=v,proto3" json:"v,omitempty"` // big.Int
	R              []byte                 `protobuf:"bytes,16,opt,name=r,proto3" json:"r,omitempty"` // big.Int
	S              []byte                 `protobuf:"bytes,17,opt,name=s,proto3" json:"s,omitempty"` // big.Int
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_block_block_proto_rawDesc = "" +
	...
	"\ttxns_root\x18\x03 \x01(\tR\btxnsRoot\x12\x1c\n" +
	"\ttimestamp\x18\x04 \x01(\x03R\ttimestamp\x12\x1d\n" +
	"\n" +
	"extra_data\x18\x05 \x01(\tR\textraData\x12\x1d\n" +
	"\n" +
	"state_root\x18\x06 \x01(\fR\tstateRoot\x12#\n" +
	"\rcoinbase_addr\x18\a \x01(\fR\fcoinbaseAddr\x12\x1b\n" +
	"\tzkvm_addr\x18\b \x01(\fR\bzkvmAddr\x12\x1b\n" +
	"\tprev_hash\x18\t \x01(\fR\bprevHash\x12\x1d\n" +
	"\n" +
	"block_hash\x18\n" +
	...
	"\vaccess_list\x18\x0e \x03(\v2\x12.block.AccessTupleR\n" +
	"accessList\x12\f\n" +
	"\x01v\x18\x0f \x01(\fR\x01v\x12\f\n" +
	"\x01r\x18\x10 \x01(\fR\x01r\x12\f\n" +
	"\x01s\x18\x11 \x01(\fR\x01s\"J\n" +
	"\vAccessTuple\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\fR\aaddress\x12!\n" +
	"\fstorage_keys\x18\x02 \x03(\fR\vstorageKeys\"\xaa\x04\n" +
	"\aZKBlock\x12\x1f\n" +
